...
// Variable: postQuery
// Query: *[_type == "post" && (slug.en.current == $slug || slug.hr.current == $slug)][0]{  _id,  title,  excerpt,  content,  coverImage{    asset,    alt  },  date,  author->{firstName, lastName},  category->{    "title": {      "en": title.en,      "hr": title.hr    },    "slug": {      "en": slug.en.current,      "hr": slug.hr.current    }  }}
