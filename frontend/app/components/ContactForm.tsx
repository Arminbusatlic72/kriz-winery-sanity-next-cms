...
// import {Button, Input, Label, Textarea, Field} from '@headlessui/react'
...
// export default function ContactForm({labels, validationErrors, onSubmit}: ContactFormProps) {
...
//     // Only show errors for fields that have been touched or have content
...
//                 placeholder={field === 'message' ? 'Enter your message here...' : undefined}
//               />
//             ) : (
//               <Input
//                 id={field}
...
//                   values[field].length > maxLength * 0.8 ? 'text-orange-600' : 'text-gray-500'
//                 }`}
//                 aria-live="polite"
//               >
